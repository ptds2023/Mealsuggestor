#' Recipes Dataset
#'
#' A dataset containing various recipes with details such as cuisine, diet, ingredients, and ratings.
#'
...
#'   \item{prep_time}{Time it takes for the preparation of the meal (numeric)}
#'   \item{cook_time}{Time it takes to cook the meal (numeric)}
#'   \item{ingredients}{Name of the ingredients delimited by "," (character)}
